...
" -------------
" any comment
hi Comment          guifg=#2B882E                                   gui=none
...
" --------------
" any constant
"hi Constant         guifg=#A39EFF                                   gui=none
hi Constant         guifg=#C93775                                   gui=none
hi Constant         ctermfg=116                                     cterm=none
" strings
hi String           guifg=#9F1B23                                   gui=none
hi String           ctermfg=110                                     cterm=none
" character constant
hi Character        guifg=#A39EFF                                   gui=none
hi Character        ctermfg=110                                     cterm=none
" numbers decimal/hex
hi Number           guifg=#A39EFF                                   gui=none
...
" ----------------
" any variable name
hi Identifier       guifg=#D47E11                                   gui=none
hi Identifier       ctermfg=216                                     cterm=none
" function, method, class
hi Function         guifg=#C93775                                   gui=none
...
" ---------------
" any statement
hi Statement        guifg=#C93775                                   gui=none
hi Statement        ctermfg=150                                     cterm=none
" if, then, else
hi Conditional      guifg=#C93775                                   gui=none
hi Conditional      ctermfg=150                                     cterm=none
" try, catch, throw, raise
hi Exception        guifg=#C93775                                   gui=none
hi Exception        ctermfg=150                                     cterm=none
" for, while, do
hi Repeat           guifg=#C93775                                   gui=none
hi Repeat           ctermfg=150                                     cterm=none
" case, default
hi Label            guifg=#C93775                                   gui=none
hi Label            ctermfg=150                                     cterm=none
" sizeof, +, *
hi Operator         guifg=#C93775                                   gui=none
hi Operator         ctermfg=150                                     cterm=none
"+ any other keyword 
hi Keyword          guifg=#C93775                                   gui=none
...
hi PreProc          guifg=#E3BA81                                   gui=none
hi PreProc          ctermfg=223                                     cterm=none
" #include
hi Include          guifg=#E3BA81                                   gui=none
hi Include          ctermfg=223                                     cterm=none
" #define
hi Define           guifg=#E3BA81                                   gui=none
hi Define           ctermfg=223                                     cterm=none
" same as define
hi Macro            guifg=#E3BA81                                   gui=none
hi Macro            ctermfg=223                                     cterm=none
" #if, #else, #endif
hi PreCondit        guifg=#E3BA81                                   gui=none
...
" ----------
" int, long, char
hi Type             guifg=#C93775                                   gui=none
hi Type             ctermfg=115                                     cterm=none
" static, register, volative
hi StorageClass     guifg=#C93775                                   gui=none
hi StorageClass     ctermfg=115                                     cterm=none
" struct, union, enum
hi Structure        guifg=#C93775                                   gui=none
hi Structure        ctermfg=115                                     cterm=none
" typedef
hi Typedef          guifg=#C93775                                   gui=none
...
hi Special          guifg=#00649F                                   gui=none
hi Special          ctermfg=181                                     cterm=none
" special character in a constant
hi SpecialChar      guifg=#C93775                                   gui=none
